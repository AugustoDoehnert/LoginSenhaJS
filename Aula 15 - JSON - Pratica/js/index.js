...
form.addEventListener("submit", (event) => {
  ...
  listaUsuarios.forEach(usuarios0 => {

    if(usuarios.email.toUpperCase() === email.trim().toUpperCase() &&
       usuarios.senha.toUpperCase() === senha.trim().toUpperCase()) {
        console.log("validou");
        //inserir em JSON e inserir no sessionStorage
        //a opçao de cima tem o <3 da prof
